...
public class MyMedicineController {
    ...
    // #1. 현재 복용 제품 목록 조회 - 사용자의 모든 복용 중인 약/영양제 목록 반환
    @GetMapping
    ...
    // #2. 현재 복용 제품 등록/수정 - 새 제품 추가 또는 기존 제품 업데이트
    @PostMapping
    ...
    // #3. 현재 복용 제품 삭제 - productId에 해당하는 복용 제품 삭제
    ...
    // #4. 사용자 ID 유효성 검증 - X-User-Id 헤더가 비어있으면 400 에러 반환
